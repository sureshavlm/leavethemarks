...
var user=require('./routes/user.js'); //http://localhost:3000/user/*
var story=require('./routes/story.js'); //http://localhost:3000/story/*
...
app.use(session({secret:"qazwsxedcrfvtgbyhnujm",resave: true, saveUninitialized: true}));//config
